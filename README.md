...
- [`View.php`](src/app/core/protocols/View.php) - базовый интерфейс представления. Определяет метод `render`, производящий "отрисовку" представления.
...
- [`HTMLView`](src/app/views/HTMLView.php) - представление на основе HTML-шаблонов. Подключает необходимый шаблон через переданный при инициализации массив названий шаблонов и путей к их файлам.
- [`RESTView`](src/app/views/RESTView.php) - представление для RESTful API на основе JSON-ответов. 
